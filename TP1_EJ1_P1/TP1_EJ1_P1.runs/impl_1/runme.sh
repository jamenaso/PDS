...
HD_PWD='/home/jamm/PDS/TP1_EJ1_P1/TP1_EJ1_P1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_alu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_alu.tcl -notrace
