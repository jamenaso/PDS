...
HD_PWD='/home/jamm/PDS/TP1_EJ1_P1/TP1_EJ1_P1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_alu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_alu.tcl
